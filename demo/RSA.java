...
import com.unionpay.gzap.client.Base64;
...
public class RSA {
     ...
     */  
    public static String PADDING = "RSA/NONE/NoPadding";  
    public static String PADDING2 = "RSA/None/PKCS1Padding";
...
//		logger.info("原文-->" + new String(Base64.decode(str)));
//	}
